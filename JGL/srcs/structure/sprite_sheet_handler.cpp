...
namespace jgl
{
	...
	void Sprite_sheet::draw(jgl::Uint sprite_id, jgl::Vector2Int pos, jgl::Vector2Int size,
		jgl::Float depth, jgl::Float alpha)
	{
		jgl::Image::draw(pos, size, _sprites[sprite_id], _unit, depth, alpha);
	}

	void Sprite_sheet::draw(jgl::Vector2Int sprite, jgl::Vector2Int pos, jgl::Vector2Int size,
		jgl::Float depth, jgl::Float alpha)
	{
